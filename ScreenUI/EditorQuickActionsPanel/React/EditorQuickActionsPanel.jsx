        ...
        <div className="flex flex-shrink-0">
          <div className="w-12 bg-[#17222c] flex flex-col items-center justify-between py-2">
            <div className="flex flex-col items-center gap-4">
              ...
              <a className="text-white relative" href="#" title="Quick Actions">
          ...
          <div className="w-64 bg-[#101922] p-2 flex flex-col border-r border-white/10">
            <div className="flex items-center justify-between mb-2">
              <h2 className="text-xs uppercase text-[#808080] font-bold px-2">Build & Run Tasks</h2>
              <div className="flex items-center">
                <button className="p-1 hover:bg-white/10 rounded" title="Add New Task">
            ...
            <div className="flex-1 overflow-y-auto text-sm">
              <div className="mb-4">
                ...
                <ul className="space-y-1 pl-6">
                  <li className="flex items-center space-x-2 text-white/80 hover:text-white hover:bg-white/10 rounded py-0.5 cursor-pointer px-2">
                    <span className="material-symbols-outlined text-base">play_arrow</span>
                    <span>Run Python File</span>
                  </li>
                  <li className="flex items-center space-x-2 text-white/80 hover:text-white hover:bg-white/10 rounded py-0.5 cursor-pointer px-2">
                    <span className="material-symbols-outlined text-base">play_arrow</span>
                    <span>Compile C File</span>
                  </li>
                  <li className="flex items-center space-x-2 text-white/80 hover:text-white hover:bg-white/10 rounded py-0.5 cursor-pointer px-2">
                    <span className="material-symbols-outlined text-base">play_arrow</span>
                    <span>Run JavaScript with Node</span>
                  </li>
                </ul>
              </div>
              <div>
                <div className="text-sm font-semibold text-white mb-2 flex items-center cursor-pointer">
                  <span className="material-symbols-outlined text-lg mr-1">expand_more</span>
                  DEFINED TASKS (SNAPPY_PROJECT)
                </div>
                <ul className="space-y-1 pl-6">
                  <li className="flex items-center space-x-2 text-white/80 hover:text-white hover:bg-white/10 rounded py-0.5 cursor-pointer px-2">
                    <span className="material-symbols-outlined text-base text-[#137fec]">play_circle</span>
                    <span>cargo build</span>
                  </li>
                  <li className="flex items-center space-x-2 text-white/80 hover:text-white hover:bg-white/10 rounded py-0.5 cursor-pointer px-2">
...
export default EditorQuickActionsPanel;