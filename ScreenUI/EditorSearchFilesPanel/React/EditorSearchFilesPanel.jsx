        ...
        <div className="flex flex-shrink-0">
          <div className="w-12 bg-[#17222c] flex flex-col items-center justify-between py-2">
            <div className="flex flex-col items-center gap-4">
              ...
              <a className="text-white relative" href="#" title="Search">
          ...
          <div className="w-64 bg-[#101922] p-2 flex flex-col border-r border-white/10">
            <h2 className="text-xs uppercase text-[#808080] font-bold px-2 mb-2">Search</h2>
            <div className="flex-1 overflow-y-auto">
              <div className="space-y-3 px-1">
                <div className="relative">
                  <input className="w-full bg-[#17222c] border border-white/10 rounded-md py-1.5 px-3 text-sm placeholder:text-[#808080] focus:ring-1 focus:ring-[#137fec] focus:border-[#137fec]" placeholder="Search" type="text" defaultValue="hello_world" />
                  <span className="material-symbols-outlined absolute right-2.5 top-1/2 -translate-y-1/2 text-lg text-[#808080]">search</span>
                </div>
                <div className="relative">
                  <input className="w-full bg-[#17222c] border border-white/10 rounded-md py-1.5 px-3 text-sm placeholder:text-[#808080] focus:ring-1 focus:ring-[#137fec] focus:border-[#137fec]" placeholder="Replace" type="text" defaultValue="hello_snappy" />
                  <span className="material-symbols-outlined absolute right-2.5 top-1/2 -translate-y-1/2 text-lg text-[#808080]">sync_alt</span>
                </div>
                <div className="flex items-center justify-end space-x-2 text-[#808080]">
                  <button className="p-1 rounded hover:bg-white/10 hover:text-white" title="Match Case"><span className="material-symbols-outlined text-lg">match_case</span></button>
                  <button className="p-1 rounded hover:bg-white/10 hover:text-white" title="Match Whole Word"><span className="material-symbols-outlined text-lg">match_word</span></button>
                  <button className="p-1 rounded hover:bg-white/10 hover:text-white" title="Use Regular Expression"><span className="material-symbols-outlined text-lg">regular_expression</span></button>
                </div>
              </div>
              <div className="mt-4">
                <div className="text-sm text-white mb-2 flex items-center cursor-pointer">
                  <span className="material-symbols-outlined text-lg mr-1">expand_more</span>
                  <span className="font-semibold">2 results in 1 file</span>
                </div>
                <ul className="space-y-1 pl-2 text-sm">
                  <li className="flex items-center space-x-2 pl-4 text-white hover:bg-white/10 rounded py-0.5 cursor-pointer">
                    ...
                    <span>main.rs</span>
                    <span className="text-xs text-[#808080] ml-auto pr-2">src</span>
                  </li>
                  <li className="pl-8 text-white bg-[#137fec]/20 hover:bg-[#137fec]/30 rounded py-1 cursor-pointer">
                    <p className="text-xs text-[#808080] px-2">5: println!("<span className="text-white bg-[#137fec]/50 rounded-sm px-0.5">hello_world</span>");</p>
                  </li>
                  <li className="pl-8 text-white hover:bg-white/10 rounded py-1 cursor-pointer">
                    <p className="text-xs text-[#808080] px-2">12: let message = "<span className="text-white bg-[#137fec]/50 rounded-sm px-0.5">hello_world</span>";</p>
                  </li>
                </ul>
              </div>
            </div>
                ...
                <table>
                  <tbody>
                    <tr>
                      ...
                      <td><span className="syntax-comment">// Welcome to Snappy IDE!</span></td>
                    </tr>
                    <tr>
                      <td className="line-number">2</td>
                      <td><span className="syntax-comment">// Edit this file to get started.</span></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td><span className="syntax-keyword">fn</span> <span className="syntax-function">main</span><span className="syntax-punctuation">() {'{'}</span></td>
                    </tr>
                    <tr>
                      <td className="line-number">5</td>
                      <td> <span className="syntax-variable">println!</span><span className="syntax-punctuation">(</span><span className="syntax-string">"Hello, world!"</span><span className="syntax-punctuation">);</span></td>
                    </tr>
                    <tr>
                      <td className="line-number">6</td>
                      <td><span className="syntax-punctuation">{'}'}</span></td>
                    </tr>
                    <tr>
...
export default EditorSearchFilesPanel;