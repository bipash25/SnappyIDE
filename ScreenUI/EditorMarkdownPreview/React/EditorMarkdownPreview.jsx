    ...
    <div className="bg-[#101922] font-['Space_Grotesk'] text-[#d4d4d4] h-screen w-full flex flex-col overflow-hidden">
        ...
        <div className="flex flex-shrink-0">
          <div className="w-12 bg-[#17222c] flex flex-col items-center justify-between py-2">
            <div className="flex flex-col items-center gap-4">
              ...
              <a className="text-[#808080] hover:text-white" href="#" title="Tools">
            ...
            <div className="flex-1 overflow-y-auto">
              ...
              <ul className="space-y-1 pl-2 text-sm">
                <li className="flex items-center space-x-2 pl-4 text-white hover:bg-white/10 rounded py-0.5 cursor-pointer">
                  <span className="material-symbols-outlined text-lg text-yellow-500 !font-light">folder</span>
                  <span>src</span>
                </li>
                <li className="flex items-center space-x-2 pl-8 text-white bg-[#137fec]/20 hover:bg-[#137fec]/30 rounded py-0.5 cursor-pointer">
          ...
          <div className="flex-1 flex overflow-hidden">
            <div className="w-1/2 flex flex-col">
              <div className="flex border-b border-white/10 flex-shrink-0 items-center justify-between pr-3">
                <div className="flex">
                  <a className="flex items-center justify-center gap-2 px-4 py-2 bg-[#101922] rounded-t-md border-r border-white/10" href="#">
                    <img className="h-4 w-4" data-alt="Markdown logo" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBl6fX2M39TEmZ-_pRWifeo2Ei9py9IZHj72nI5VhaYV0B6J6lA7hrCkjy2RPuK_BAJziwHsvE846UD-bfxWOse2HD3z2CvkJOjbeHLmcsrhKs19fPRYSJ_28KOoMAW7K5UeESEZ4B5xRuiOer14UDr_pfu3PgkbeTGRbupbqCCf23Fbfynha73V49KdW1dChq7T3kfz8UuqddWn2uSHM1bwhNC1T7ysO42eNVdqQwCC9ycu7fdRopV3a_Uah_zF9pfieDgl7fQrs7r" alt="Markdown logo" />
                    <p className="text-white text-sm font-medium leading-normal">README.md</p>
                  ...
                  <a className="flex items-center justify-center gap-2 px-4 py-2 text-[#808080] hover:bg-white/5 group rounded-t-md" href="#">
                    ...
                    <p className="text-sm font-medium leading-normal">main.rs</p>
              ...
              <div className="flex flex-1 overflow-hidden">
                <div className="flex-1 font-mono text-sm leading-6 overflow-y-auto p-2">
                  <table>
                    <tbody>
                      <tr><td className="line-number">1</td><td><span className="syntax-macro"># Snappy Project</span></td></tr>
                      <tr><td className="line-number">2</td><td></td></tr>
                      <tr><td className="line-number">3</td><td><span className="syntax-comment">A production-grade, cross-platform IDE.</span></td></tr>
                      <tr><td className="line-number">4</td><td></td></tr>
                      <tr><td className="line-number">5</td><td><span className="syntax-macro">## Features</span></td></tr>
                      <tr><td className="line-number">6</td><td><span className="syntax-punctuation">- </span><span className="syntax-string">High performance</span></td></tr>
                      <tr><td className="line-number">7</td><td><span className="syntax-punctuation">- </span><span className="syntax-string">Comprehensive debugging tools</span></td></tr>
                      <tr><td className="line-number">8</td><td><span className="syntax-punctuation">- </span><span className="syntax-string">Git integration</span></td></tr>
                    </tbody>
                  </table>
                </div>
            ...
            <div className="w-1/2 flex flex-col border-l border-white/10">
              <div className="flex-shrink-0 h-10 flex items-center justify-between px-3 border-b border-white/10 bg-[#17222c]/50">
                <p className="text-sm text-white/80">README.md Preview</p>
                <button className="p-1.5 rounded hover:bg-white/10 text-white/80 hover:text-white">
                  <span className="material-symbols-outlined text-lg">more_vert</span>
                </button>
              </div>
              <div className="flex-1 overflow-y-auto p-6 bg-white text-gray-800">
                <div className="prose prose-sm max-w-none">
                  <h1 className="text-3xl font-bold mb-4">Snappy Project</h1>
                  <p className="mb-4 text-gray-600">A production-grade, cross-platform IDE.</p>
      ...
      <div className="flex-shrink-0 bg-[#137fec] h-6 flex items-center justify-between px-3 text-white text-xs">
        ...
        <div className="flex items-center gap-4">
          ...
          <a className="flex items-center gap-1 hover:bg-white/20 px-1 rounded" href="#" title="Live Preview">
            <span className="material-symbols-outlined text-sm fill">visibility</span>
          </a>
        </div>
      </div>
    </div>
...
export default EditorMarkdownPreview;